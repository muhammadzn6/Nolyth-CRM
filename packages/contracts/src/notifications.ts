...
export const activityListQuerySchema = z.strictObject({ companyId: uuidSchema.optional(), leadId: uuidSchema.optional(), profileId: uuidSchema.optional(), search: text.max(120).optional(), limit: z.coerce.number().int().min(1).max(100).default(50) });
