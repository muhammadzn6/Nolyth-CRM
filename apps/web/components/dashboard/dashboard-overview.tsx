...
function BdDashboardKpiStrip({ applications, openTasks, calendarInterviews }: { applications: LeadSummary[]; openTasks: TaskSummary[]; calendarInterviews: InterviewSummary[] }) {
...
export function DashboardOverview({ actor, dashboard, recentActivity, calendarInterviews, openTasks = [], applications = [], error }: { actor: SessionUser; dashboard?: DashboardData; recentActivity?: ActivityEventSummary[]; calendarInterviews?: InterviewSummary[]; openTasks?: TaskSummary[]; applications?: LeadSummary[]; error?: string }) {
  ...
  return <div className="mx-auto max-w-[1500px]">
    ...
    <div className="mt-6">{actor.role === "BD" ? <BdDashboardKpiStrip applications={applications} calendarInterviews={calendarInterviews ?? []} openTasks={openTasks} /> : <DashboardKpiStrip dashboard={dashboard} calendarInterviews={calendarInterviews} />}</div>
